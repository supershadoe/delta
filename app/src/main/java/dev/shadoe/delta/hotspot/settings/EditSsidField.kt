...
internal fun EditSsidField(
    ...
    Box(
        modifier = Modifier
            .fillMaxWidth()
            .clickable(
                onClickLabel = "Edit SSID", role = Role.Button,
            ) {
        ...
        Row(
            ...
            Icon(
                imageVector = Icons.Rounded.Wifi, contentDescription = "SSID icon"
            )
            Column(modifier = Modifier.padding(start = 16.dp)) {
                Text(text = "SSID")
                Text(text = textFieldState.value)
            }
        }
    }
