...
public class TetheringManager {
    ...
    public void startTethering(@NonNull final TetheringRequest request, @NonNull final Executor executor, @NonNull final StartTetheringCallback callback) {
     ...
     *                 TetheringRequest will be invoked.
     */
    public void startTethering(int type, @NonNull final Executor executor, @NonNull final StartTetheringCallback callback) {
        throw new RuntimeException("stub!");
    }
     ...
     */
    public void stopTethering(@NonNull TetheringRequest request, @NonNull final Executor executor, @NonNull final StopTetheringCallback callback) {
    ...
    public static final class TetheringRequest implements Parcelable {
        ...
        public static class Builder {
             ...
             */
            @NonNull
            public Builder setStaticIpv4Addresses(@NonNull final LinkAddress localIPv4Address, @NonNull final LinkAddress clientAddress) {
                throw new RuntimeException("stub!");
            }
